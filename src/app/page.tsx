...
// Every capability opens with its own visual: the generated app for full-stack builds,
// the agent roster for autonomous workflows, and the connected mobile app for the rest.
const FEATURE_APP_IMAGE = {
  src: "/feature-generated-app.jpg",
  alt: "An application generated by QuickStart.Ai running on desktop and mobile",
};
const FEATURE_AGENTS_IMAGE = {
  src: "/feature-agents-workflows.jpg",
  alt: "A team of QuickStart.Ai agents handling research, writing, and everyday tasks",
};
const FEATURE_INTEGRATIONS_IMAGE = {
  src: "/feature-connected-services.jpg",
  alt: "A phone toggling QuickStart.Ai connections to an MCP server, a knowledge base, and GitHub",
};

const FEATURES = [
  { icon: Zap, title: "AI Full Stack Generation", desc: "Generate user-interfaces, structural databases, route endpoints, third-party authentication protocols, and edge APIs dynamically from one single baseline prompt.", tag: "Autonomous Architecture", image: FEATURE_APP_IMAGE },
  { icon: Layout, title: "Frontend Engine", desc: "Beautiful layouts compiled using Next.js 15, Tailwind, and React 19. Perfectly customized components natively designed to match standard screen resolutions dynamically.", tag: "Next.js 15 & React 19", image: FEATURE_INTEGRATIONS_IMAGE },
  { icon: Server, title: "Sovereign Backend", desc: "Engineered Node.js, Express, and Serverless API structures. Type-safe routing controls, absolute payload validations, dynamic load balancing, and secure headers.", tag: "Type-safe endpoints", image: FEATURE_INTEGRATIONS_IMAGE },
  { icon: Database, title: "Database Integration", desc: "Structured SQL/NoSQL schema schemas automatically constructed. Deep-link models to Supabase, Postgres, Firebase, or complex remote Vector Databases.", tag: "PostgreSQL & Supabase", image: FEATURE_INTEGRATIONS_IMAGE },
  { icon: ShieldCheck, title: "Enterprise Authentication", desc: "Out-of-the-box user management. Integrate secure multi-factor MFA, JSON Web Tokens (JWT), biometric passkeys, NextAuth setups, or OAuth profiles seamlessly.", tag: "Zero-trust security", image: FEATURE_INTEGRATIONS_IMAGE },
  { icon: Cpu, title: "AI Agents & Workflows", desc: "Embed complex autonomous systems into your software application. Orchestrate background processors, webhooks, Vector memory searches, and Stripe-enabled actions.", tag: "Autonomous workflows", image: FEATURE_AGENTS_IMAGE },
];
            ...
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
              ...
              <Reveal>
                <div className="relative aspect-[4/3] w-full overflow-hidden rounded-premium border border-brandBorder bg-brandSurface">
                  <Image
                    key={FEATURES[activeFeature].image.src}
