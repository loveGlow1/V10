                  ...
                  <div className="py-5">
                    <div className="flex items-center justify-between gap-4 rounded-xl border border-line/[0.07] bg-layer/[0.03] px-6 py-5">
                      ...
                      <button
                        ...
                        className="flex h-10 shrink-0 items-center gap-2 rounded-lg bg-gradient-to-b from-accentBright to-accent px-4 text-sm font-semibold text-onSolid transition-all hover:brightness-105"
                      >
                  ...
                  <>
                    ...
                    <div className="border-t border-line/[0.06] pb-6 pt-6">
                      ...
                      <div className="mt-3 flex items-center justify-between gap-4 rounded-xl border border-line/[0.07] bg-layer/[0.03] px-6 py-5">
                        ...
                        <button
                          onClick={onUpgradeClick}
                          className="flex h-10 items-center gap-2 rounded-lg bg-gradient-to-b from-accentBright to-accent px-4 text-sm font-semibold text-onSolid transition-all hover:brightness-105"
                        >
                          Upgrade Plan <Sparkles className="h-4 w-4" />
                        </button>
                      </div>
