        ...
        return (
          <motion.button
            ...
            animate={
              isSelected
                ? {
                    /* The accent, because a chosen plan is an active state and
                       the accent is what active looks like here. Written as
                       channels because framer-motion animates an inline value
                       and cannot read a CSS variable mid-tween. */
                    boxShadow: "0 0 0 2px rgb(184 160 255), 0 0 20px rgb(184 160 255 / 0.18)",
                  }
