  ...
  return (
    <div ref={rootRef} className="relative mt-9 hidden md:block">
      <button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        className="flex h-[42px] w-[210px] max-w-[calc(100vw-40px)] items-center justify-center gap-2 rounded-full border border-line/[0.08] bg-layer/[0.04] px-4 text-sm text-ink transition-colors hover:bg-layer/[0.07]"
      >
        <span
        ...
        {open && (
          ...
          >
            {projects.map((project) => (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block truncate text-[13px] text-muted">Owner · 1 member</span>
                </span>
            ...
            {creating ? (
              ...
              >
                <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-layer/[0.06]">
