            ...
            <div className="mt-3 shrink-0 space-y-2 border-t border-line/[0.06] pt-3">
              ...
              <div className="rounded-[20px] bg-layer/[0.03] border border-line/[0.08] p-3.5 flex items-center justify-between shadow-lg">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-onSolid bg-solid px-4 py-2 rounded-full hover:brightness-105 transition-all flex items-center gap-1.5 shadow-[0_0_15px_rgba(244,217,107,0.25)]"
                >
                  <span>Upgrade</span>
                    ...
                    >
                      ...
                      <div className="mx-3 mb-3 rounded-xl border border-line/[0.06] bg-layer/[0.03] p-3">
                        ...
                        <button
                          ...
                          className="mt-2.5 h-9 w-full rounded-lg bg-solid text-[13px] font-semibold text-onSolid transition-all hover:brightness-105 active:scale-[0.99]"
                        >
                          Upgrade
                        </button>
                      </div>
