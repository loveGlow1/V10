...
export default function TopBar({
  ...
  const upgrade = (
    <button
      ...
      className="flex h-[34px] shrink-0 items-center rounded-full bg-solid px-3.5 text-[12px] font-semibold leading-none text-onSolid transition-opacity hover:opacity-90 active:scale-[0.98]"
    >
      Upgrade
    </button>
  );
