...
export default function DashboardFooter() {
  ...
  const linkClass =
    "text-[14px] text-[#8F939A] transition-colors hover:text-white focus-visible:text-white focus-visible:outline-none";

  return (
    <footer className="relative z-10 w-full border-t border-white/[0.06] px-5 pb-10 pt-14 md:px-8">
      <div className="mx-auto w-full max-w-[1180px]">
        <div className="grid gap-x-8 gap-y-10 md:grid-cols-[minmax(0,1.2fr)_repeat(4,minmax(0,1fr))]">
          <div className="max-w-[360px]">
            ...
            <p className="mt-4 text-[14px] leading-relaxed text-[#8F939A]">
          ...
          {COLUMNS.map((column) => (
            <div key={column.title}>
              <h3 className="text-[15px] font-semibold text-white">{column.title}</h3>
        ...
        <div className="mt-12 flex flex-col items-center gap-6 border-t border-white/[0.06] pt-6 md:flex-row md:justify-between">
          <p className="text-[12px] uppercase tracking-[0.14em] text-[#6F737A]">
            Copyright © QuickStark.Ai {year}
          </p>

          <p className="text-center text-[12px] uppercase leading-relaxed tracking-[0.14em] text-[#6F737A]">
            ...
            {SOCIALS.map((social) => {
              ...
              return (
                <span
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.07] text-[#6F737A]"
                >
